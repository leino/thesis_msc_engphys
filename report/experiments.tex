...
By corollary \ref{cor:hypergraph_bipartite_bijection}, we can generate the class of hyper-graphs with 4 vertices and 2 hyper-edges which have either 2 or 3 vertices in them, by running:
