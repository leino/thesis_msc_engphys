...
As we can see (and have already stated in the previous chapter), most of the comparisons are trivial: Unexplored nodes always win over explored nodes and tie against each other.
