...
Thus, using equation \ref{eq:uctnodevalue}, we get $\sqrt{\ln{5}} - 1$ for the first choice, and $\sqrt{\ln{5}} + 1$ for the other three choices.
Therefore, let us select the second node since it maximizes equation \ref{eq:uctnodevalue}.
